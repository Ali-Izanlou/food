...
export default function ShoppBtn() {
    return (
        <div className="inline-flex gap-8  py-3 px-8 items-center justify-center rounded-r-full rounded-l-full text-Rose-50 bg-Red  ">
            <button className= " border px-1 py-2 border-Rose-50 rounded-full text-Rose-50 group hover:bg-Rose-50" >
            ...
            <span>0</span>
            <button  className= " border p-1 border-Rose-50 rounded-full group hover:bg-Rose-50">           
